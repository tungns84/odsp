...
public class ConnectorService {
    ...
    public ConnectorService(DataSourceFactory dataSourceFactory, MetadataInferenceService metadataInferenceService) {
        this.dataSourceFactory = dataSourceFactory;
        this.metadataInferenceService = metadataInferenceService;
    }

    public List<com.example.ldop.dto.TableMetadata> fetchTables(Connector connector) {
        return testConnectionAndFetchTables(connector.getConfig());
    }

    public List<com.example.ldop.dto.TableMetadata> testConnectionAndFetchTables(Map<String, Object> config) {
        ...
        try {
            ...
            return jdbi.withHandle(handle -> {
                ...
                // Group by table name
                Map<String, List<com.example.ldop.dto.ColumnMetadata>> tablesMap = rows.stream()
                        .collect(java.util.stream.Collectors.groupingBy(
                                ...
                                java.util.stream.Collectors.mapping(
                                        row -> {
                                            ...
                                            com.example.ldop.dto.ColumnMetadata column = new com.example.ldop.dto.ColumnMetadata();
                ...
                return tablesMap.entrySet().stream()
                        .map(entry -> {
                            com.example.ldop.dto.TableMetadata table = new com.example.ldop.dto.TableMetadata();
