...
public class ConnectorService {
    ...
    public List<com.gs.dsp.dto.TableMetadata> fetchTables(Connector connector) {
    ...
    public List<com.gs.dsp.dto.TableMetadata> testConnectionAndFetchTables(Map<String, Object> config) {
        ...
        try {
            ...
            return jdbi.withHandle(handle -> {
                ...
                // Group by table name
                Map<String, List<com.gs.dsp.dto.ColumnMetadata>> tablesMap = rows.stream()
                        .collect(java.util.stream.Collectors.groupingBy(
                                ...
                                java.util.stream.Collectors.mapping(
                                        row -> {
                                            ...
                                            com.gs.dsp.dto.ColumnMetadata column = new com.gs.dsp.dto.ColumnMetadata();
                ...
                return tablesMap.entrySet().stream()
                        .map(entry -> {
                            com.gs.dsp.dto.TableMetadata table = new com.gs.dsp.dto.TableMetadata();
